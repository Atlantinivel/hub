...
export const columns: ColumnDef<User>[] = [
    ...
    },
    {
        ...
        header: 'Numero',
        cell: ({ row }) => {
            return <div className='font-medium'>{row.getValue('employeeNumber')}</div>
        }
    },
    {
        accessorKey: 'email',
    ...
    },
    {
        ...
        header: 'Departamento',
        cell: ({ row }) => {
            const item = departments.find((el) => el.id == row.getValue('department'))
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align='end'>
                        ...
                        <DropdownMenuSeparator />
                        <Link href={`/hub/users/user/${user.id}`}><DropdownMenuItem>Ver/editar</DropdownMenuItem></Link>
